...
import YourMap from "../other/YourMap"
            ...
            <div className="trinity">
                <div className="trinity_item">
                    <div className="vertical-flex">
                        ...
                        <p>We are certainly following you</p>
                        {/* <YourMap lat={this.state.mapData.lat} lng={this.state.mapData.lng} zoom={10} getMyLocation={this.getMyLocation}/> */}
                    </div>
